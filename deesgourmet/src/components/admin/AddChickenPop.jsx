...
import { PostChicken } from "../../api/ApiChicken";
import { useState } from "react";
export default function AddChickenPop({ 
  showAddChickenPop, onClick}) {
    ...
    const saveFormData = async () => {
      const api_request = await PostChicken(formValues);
