...
import { PostSeafood } from "../../api/ApiSeafood";
import { useState } from "react";
export default function AddSeafoodPop({ 
  showAddSeafoodPop, onClick}) {
    ...
    const saveFormData = async () => {
      const api_request = await PostSeafood(formValues);
