...
import { PostRice } from "../../api/ApiRice";
import { useState } from "react";
export default function AddRicePop({ 
  showAddRicePop, onClick}) {
    ...
    const saveFormData = async () => {
      const api_request = await PostRice(formValues);
