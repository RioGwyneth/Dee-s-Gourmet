...
import AddDessertPop from "../../components/admin/AddDessertPop";
export default function ManageDessertPage() {
  ...
  const [showAddDessertPop, setShowAddDessertPop] = useState(false);
  ...
  return (
    ...
    <div>
      ...
      />
 <AddDessertPop
       showAddDessertPop={showAddDessertPop}
       onClick={() => setShowAddDessertPop(false)}
      />
      <AdminNavbar />
      <div className="flex flex-col p-10">
        ...
        <div className="">
        <Button text="Add Food" bgcolor="bg-red-600" padding="px-6 py-2"  onClick={() => setShowAddDessertPop(true)} />
        </div>
        </div>
